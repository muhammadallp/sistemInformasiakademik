        ...
        <div class="card-body">
            ...
            <form method="post" action="/kelas/">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kelas" class="form-control @error('kelas') is-invalid @enderror" id="kelas" autofocus value="{{ old('kelas') }}">
                  @error('kelas')
...
<script>
    ...
    kelas.addEventListener('change', function(){
        fetch('/kelas/posts/checkSlug?kelas=' + kelas.value)
